...
//    - detallesCejas
//    - fotosCejas
export default function DetallesFaciales({ clientaID, detalles, w = "70%" }) {
  return (
    <VStack w={["100%", w]} align={"start"} gap={"1.5rem"}>
      <Heading size={"2xl"}>Fotos y Detalles:</Heading>
      <FotosCejas clientaID={clientaID} />

      <DescripcionCejas clientaID={clientaID} detalles={detalles} />
    </VStack>
  );
}
